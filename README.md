...
- [Índice](#índice)
  ...
  - [Invalid hook call ao abrir a página do storybook](#invalid-hook-call-ao-abrir-a-página-do-storybook)
  ...
  - [Quando tento popular os games ocorre um erro na tentativa de upload das imagens](#erro-upload-de-imagens)
